...
public class Photon {
   ...
   public final float[] surfaceNormal;
   public final float intensity;
   public final LightAttribution value;

   public Photon(final float[] color, final float[] location, final float[] incomingDir, final float[] surfaceNormal, final float intensity, final LightAttribution value) {
      this.color = color;
